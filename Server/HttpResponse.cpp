...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/20 21:13:40 by atazzit           #+#    #+#             */
/*   Updated: 2026/02/20 23:47:37 by atazzit          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void HttpResponse::autoDetectContentType(const std::string& path){
    ...
    if (ext == ".html" || ext == ".htm") setHeader("Content-Type", "text/html");
    else if (ext == ".css") setHeader("Content-Type", "text/css");
    else if (ext == ".js")  setHeader("Content-Type", "application/javascript");
    else if (ext == ".png") setHeader("Content-Type", "image/png");
    else if (ext == ".jpg" || ext == ".jpeg") setHeader("Content-Type", "image/jpeg");
    else if (ext == ".gif") setHeader("Content-Type", "image/gif");
    else if (ext == ".ico") setHeader("Content-Type", "image/x-icon");
    else if (ext == ".pdf") setHeader("Content-Type", "application/pdf");
