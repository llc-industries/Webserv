...
if user_session == "42_is_awesome":
    ...
    if "user=admin" in query:
        ...
        print("<p>Le cookie vient d'etre pose. <a href='/cgi-tests/python/login_save.py'>Actualisez la page</a>.</p>")
    else:
        print("\r\n")
        print("<h1>Page de Login</h1>")
        print("<form action='/cgi-tests/python/login_save.py' method='GET'>")
